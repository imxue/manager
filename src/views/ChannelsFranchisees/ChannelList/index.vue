  ...
  <div class="ChannelList">
    ...
    <div class="cl-main">
      ...
      >
        ...
        <el-table-column prop="menu_type" label="菜单类型" width="158">
    ...
    <el-dialog title="编辑渠道列表" :visible.sync="dialogFormVisible">
      <el-form :model="editData" status-icon ref="form" label-width="100px">
        ...
        <el-form-item label="更新地址" prop="checkPass">
          <el-select
            v-model="editData.upgrade_version_id"
  ...
  methods: {
    ...
    async HandleGetUdate() {
      try {
        ...
        this.editData.upgrade_version_id = this.UpgradeUrl[0].id;
      } catch (error) {
        console.log(error);
      } finally {
